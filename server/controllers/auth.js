  ...
  .then((user) => {
    ...
    if (!user) {
     ...
     console.log("no such user")
      ...
      const { _id, email, name, role ,showOnce,instituteName,state,country,department,semester,year,labtype,university} = user;
      console.log("hello",user)
      res.json({
        user: { _id, email, name, role,showOnce,instituteName,state,country,department,semester,year,labtype,university},
      });
    }
  })
