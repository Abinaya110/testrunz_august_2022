        ...
        <div>
          {details && (
            <p style={{ padding: "15px" }}>
              ...
              <br />
              <span style={{ fontWeight: "bold", paddingRight: "20px" }}>
                Total no of runz created in this Department:
              </span>
              {details.listofrunz}
              <br />
              <span style={{ fontWeight: "bold", paddingRight: "20px" }}>
        ...
        {departmentlist &&
          departmentlist.map((item) => {
            return (
              ...
              >
                <span style={{ fontWeight: "bold" }}>Department:</span> {item}
                <br />
                <span style={{ fontWeight: "bold" }}>Institute:</span>{" "}
                {instituteName}
                <br />
