...
const getmoreinfo=(lab,institute,university)=>{
  ...
  fetch(`${ApiUrl}/moreInfo/getdetail/university/institute/department/admin`,{
    method: "POST",
      ...
      
{
            ...
            lablist.map((item)=>{
                return (
                  <Paper elevation={3}  key={item} style={{padding:'10px',paddingTop:'25px',paddingBottom:'20px',backgroundColor:'	#E5E4E2',cursor: "pointer"}} onClick={()=>{getmoreinfo(item,instituteName,university)}} > 
